...
import { CandidateReferences } from "./candidaterefences";
...
export class CandidateMaster {
    ...
    constructor() {
      ...
      this.PayRate="0";
      this.AccountMasters=[];
      this.CandidateReferences=[];
      this.CommunicationSkillRating="0";
      this.TechnicalSkillRating="0";
      this.CandidatesMapping=[];
      this.bgClass=null;
      this.ManagerList=[];
    }
