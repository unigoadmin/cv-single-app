...
import { ConfirmDialogNotesComponent } from './confirm-dialog-notes/confirm-dialog-notes.component';
import { ConfirmDeleteDialogComponent } from './confirm-delete-dialog/confirm-delete-dialog.component';


import { SortReportComponent } from './sort-report/sort-report.component';
import { ConfirmDialogExistsComponent } from './confirm-dialog-exists/confirm-dialog-exists.component';
import { SkillsAutocompleteComponent } from './skills-autocomplete/skills-autocomplete.component';
import {InternalUsersChipsComponent} from './internal-users-chips/internal-users-chips.component';
...
@NgModule({
    declarations: [ TextBoxComponent,  
                   ConfirmDialogNotesComponent, ConfirmDeleteDialogComponent,
                   SortReportComponent, ConfirmDialogExistsComponent,SkillsAutocompleteComponent,InternalUsersChipsComponent,HashtagsChipsComponent,SessionAlertComponent],
  imports: [
    CommonModule,
    PageLayoutModule,
    BreadcrumbsModule,
  ...
  exports:[TextBoxComponent, SkillsAutocompleteComponent,InternalUsersChipsComponent,HashtagsChipsComponent,SessionAlertComponent]
})
export class FilterComponentsModules {
}
