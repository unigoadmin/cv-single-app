...
import { CandidateMaster } from '../../../models/candidatemaster';

@Component({
  selector: 'cv-candidate-exists',
  templateUrl: './candidate-exists.component.html',
  styleUrls: ['./candidate-exists.component.scss'],
...
export class CandidateExistsComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CandidateExistsComponent>,
