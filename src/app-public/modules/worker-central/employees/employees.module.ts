...
import { CommonEmployeeViewComponent } from './common-employee-view/common-employee-view.component';
import { TerminateEmployeeComponent } from './terminate-employee/terminate-employee.component';


@NgModule({
  declarations: [ EmployeesComponent, AddEmployeeComponent, EditEmployeeComponent,DocViewerComponent, ViewEmployeeComponent, EditPlacementEmployeeComponent, ViewPlacementEmployeeComponent, CommonEmployeeViewComponent, TerminateEmployeeComponent],
  imports: [
    CommonModule,
