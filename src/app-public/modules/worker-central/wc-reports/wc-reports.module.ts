...
import { WCReportsRoutingModule } from './wc-reports.routing.module';
import { WcStandardReportsComponent } from './wc-standard-reports/wc-standard-reports.component';
import { WcCustomReportsComponent } from './wc-custom-reports/wc-custom-reports.component';


@NgModule({
    declarations: [WCReportsComponent,WcStandardReportsComponent,WcCustomReportsComponent ],
    imports: [
        CommonModule,
        PageLayoutModule,
        FlexLayoutModule,
        ...
        NgxMatTimepickerModule,
        NgxMatNativeDateModule,
        WCReportsRoutingModule
      ],
      schemas:[CUSTOM_ELEMENTS_SCHEMA ],
      providers:[ValidationService,PopoverService]
})
export class WCReportModule{}