...
@Component({
  selector: 'cv-plc-confirm-dialog',
  templateUrl: './plc-confirm-dialog.component.html',
  styleUrls: ['./plc-confirm-dialog.component.scss']
})
export class PlcConfirmDialogComponent implements OnInit {
  title: string;
  message: string;
  DeleteNotes: string;
  icClose = icClose;
  placeholder: string;
  constructor(public dialogRef: MatDialogRef<PlcConfirmDialogComponent>,
