...
import { SettingNotifyComponent } from './ts-settings/setting-notify/setting-notify.component';
import { TimesheetFeaturesComponent } from './ts-settings/timesheet-features/timesheet-features.component';
import {ShortenpipeModule } from 'src/@cv/pipes/shortenpipe/shortenpipe.module';
import { NgxPermissionsModule } from 'ngx-permissions';

@NgModule({
  declarations: [TimesheetsComponent, AddTimesheetComponent, TimesheetDocViewerComponent, TimesheetAddTaskComponent,ManagerDashboardComponent,TimesheetNotesComponent, ViewTimesheetComponent, ManagerViewComponent,TsSettingsComponent, SettingNotifyComponent, TimesheetFeaturesComponent],
  imports: [
    CommonModule,
