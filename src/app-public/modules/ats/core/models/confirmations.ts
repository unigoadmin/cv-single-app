export class Placement{
    ...
    ConfirmationAccountMappings:ConfirmationAccountMappings[];
    JobCategory:number;
    ...
    constructor(){
        ...
        this.ConfirmationAccountMappings=[];
...
export class ConfirmationAccountMappings {
    ConfirmationAccountMappingID: number;
    ConfirmationID: number;
    AccountID: number;
    MappingStatus: boolean
    CreatedDate: Date;
    ...
    BillingPOC:ConfirmationAcctContactInfo;
    ImmigrationPOC:ConfirmationAcctContactInfo;
    SalesPOC:ConfirmationAcctContactInfo;
    ConfirmationAcctContactInfo:ConfirmationAcctContactInfo[];
    constructor() {
        this.ConfirmationAccountMappingID=0;
        this.ConfirmationID=0;
        this.AccountID=0;
        ...
        this.BillingPOC=new ConfirmationAcctContactInfo();
        this.ImmigrationPOC=new ConfirmationAcctContactInfo();
        this.SalesPOC=new ConfirmationAcctContactInfo();
        this.ConfirmationAcctContactInfo=[];
    }
}
export class ConfirmationAcctContactInfo {
