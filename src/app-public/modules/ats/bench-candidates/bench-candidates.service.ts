...
export class BenchCandidateService extends BaseService {
  ...
  GetAllBenchCandidates(benchCandidateSearch: any): Observable<any> {
    const url = this.marketingdashboard_api + '/GetAllBenchCandidates'
    return this.apiservice.post(url, benchCandidateSearch);
  }
...
// }
  ...
  // getBenchSubUsers(companyId: number): Observable<SubUsers[]> {
  //   const url = this.marketingdashboard_api + '/GetBenchSubUsers/'+companyId
