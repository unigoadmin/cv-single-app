...
@Component({
  selector: 'cv-widget-applicants-count',
  templateUrl: './widget-applicants-count.component.html',
  styleUrls: ['./widget-applicants-count.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  animations: [scaleInOutAnimation]
})
export class WidgetApplicantsCountComponent implements OnInit {
