...
import { CandidatesListRoutingModule } from './candidates-lst-routing.module';
...
@NgModule({
    declarations: [CandidatesListComponent,AddCandidateComponent, EditCandidateComponent, CandidateAssignComponent],
    imports: [
        CommonModule,
