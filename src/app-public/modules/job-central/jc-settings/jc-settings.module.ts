...
import { JcSettingsRoutingModule } from './jc-settings-routing.module';
...
import {FormPermissonsTableModule} from 'src/@shared/components/form-permissons-table/form-perissions-table.module';


@NgModule({
    declarations: [JcSettingsComponent, ApplicantStatusComponent, NotificationSettingsComponent, FormSettingsComponent],
    imports: [
        CommonModule,
        JcSettingsRoutingModule,
        PageLayoutModule,
        FlexLayoutModule,
        BreadcrumbsModule,
        MatPaginatorModule,
        ...
        ShortenpipeModule,
        FormPermissonsTableModule,
        
      ],
      schemas:[CUSTOM_ELEMENTS_SCHEMA ],
      providers:[ValidationService]
})
export class JobCentralSettingsModule { }