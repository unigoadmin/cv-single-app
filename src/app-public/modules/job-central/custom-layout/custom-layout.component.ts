...
import { JcNavigationService } from '../services/jc-navigation.service';
...
export class CustomLayoutComponent implements OnInit {
  ...
  SessionSettings: CompanySessionSettings = new CompanySessionSettings();
  ...
  constructor(private layoutService: LayoutService,
              ...
              private jcNavigationService: JcNavigationService) { }

  ngOnInit() {
    this.jcNavigationService.initializeNavigation();
