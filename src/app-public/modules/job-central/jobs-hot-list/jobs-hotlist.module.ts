...
import {JobsHotListRoutingModule } from './jobs-hotlist-routing.module';
...
@NgModule({
    declarations: [JobsHotListComponent,JobsHotlistEmailSettingsComponent],
    imports: [
        CommonModule,
        PageLayoutModule,
        FlexLayoutModule,
...
export class JobsHotListModule { }