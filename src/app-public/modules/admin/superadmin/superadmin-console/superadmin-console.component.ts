...
@UntilDestroy()
@Component({
  selector: 'cv-superadmin-console',
  templateUrl: './superadmin-console.component.html',
  styleUrls: ['./superadmin-console.component.scss'],
  animations: [
    fadeInUp400ms,
    stagger40ms
  ],
...
export class SuperadminConsoleComponent implements OnInit {
