...
import { SuperAdminConsoleRoutingModule } from '../superadmin-console/superadmin-console-routing.module';
import { SuperadminConsoleComponent } from '../superadmin-console/superadmin-console.component';


@NgModule({
  declarations: [SuperadminConsoleComponent],
  imports: [
    CommonModule,
    SuperAdminConsoleRoutingModule,
...
export class SuperAdminConsoleModule { }
