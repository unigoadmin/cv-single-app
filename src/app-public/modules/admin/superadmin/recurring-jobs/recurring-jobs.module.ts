...
import { RecurringJobsRoutingModule } from './recurring-jobs-routing.module';
import { RecurringJobsComponent} from './recurring-jobs.component';


@NgModule({
  declarations: [RecurringJobsComponent],
  imports: [
    CommonModule,
    RecurringJobsRoutingModule,
